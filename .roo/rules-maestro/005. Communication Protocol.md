...
- **Status Reporting Requirements**: All status updates provided to the user MUST include:
  ...
  - List of completed design tasks and key outcomes since the last update.
  - List of currently pending design tasks and their estimated sequence/dependencies.
  - Any identified issues, blockers, or risks requiring user attention or decision.
  - Key architectural decisions made since the last update.
