...
This is a modified version of the Maestro-mode.md file for the "devops" mode set.
The following modes are included in this set: Deploymentmaster, Cloudforge, Gitmaster, Jiramanager, Devsecops, Cloudformationexpert, Maestro.
