...
This is a modified version of the Maestro-mode.md file for the "planning" mode set.
The following modes are included in this set: Visionary, Strategist, Blueprinter, Planreviewer, Maestro, Jiramanager.
